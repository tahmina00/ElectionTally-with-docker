...
const Candidateedit = () => {
	...
	try{
	const res = await fetch(`http://localhost:5000/searchbyelectionid/${electionid}`,{
	method: "GET",
	headers:{
	...
	try{
	const res = await fetch('http://localhost:5000/getconstbangladata',{
	...
	try{
	const res = await fetch(`http://localhost:5000/candidateedit/${electionid}`,{
	method: "GET",
	headers:{
	Accept: "application/json",
	"Content-Type": "application/json"
